...
class SimpleWheelAdapter extends RecyclerView.Adapter {
    ...
    public ListerSelect listerSelect;

    public interface ListerSelect{
        void selectItem(int pos);
    }

    public ListerSelect getListerSelect() {
        return listerSelect;
    }

    public void setListerSelect(ListerSelect listerSelect) {
        this.listerSelect = listerSelect;
    }


    public void  setSelectPos(int pos){
         adapter.getSelect(pos);
    }
